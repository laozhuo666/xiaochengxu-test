...
import com.cod.pojo.Users;
import com.cod.pojo.UsersReport;
import com.cod.pojo.vo.PublisherVideo;
import com.cod.pojo.vo.UsersVO;
...
public class UserController extends BasicController {
	...
	@PostMapping("/query")
	public VideoJSONResult query(String userId, String fanId) throws Exception {
	...
	public VideoJSONResult queryPublisher(String loginUserId, String videoId, 
	...
	public VideoJSONResult beyourfans(String userId, String fanId) throws Exception {
	...
	public VideoJSONResult dontbeyourfans(String userId, String fanId) throws Exception {
	...
	public VideoJSONResult reportUser(@RequestBody UsersReport usersReport) throws Exception {
		...
		return VideoJSONResult.errorMsg("举报成功...有你平台变得更美好...");
	}
